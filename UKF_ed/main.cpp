...
int main() {
    ...
    string in_file_name_ = "/home/likun/CLionProjects/UKF_ed/obj_pose-laser-radar-synthetic-input.txt";
	...
	string line;
	// set i to get only first 30 measurments
	int i = 0;
	...
	for (size_t k = 0; k < N; ++k) {	//start filtering from the second frame (the speed is unknown in the first frame)
		...
		kalmanf.ProcessMeasurement(measurement_pack_list[k]);

		std::cout<< "x: " << kalmanf.x_ << std::endl;
